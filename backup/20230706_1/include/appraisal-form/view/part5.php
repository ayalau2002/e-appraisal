<div class="card">
    <div class="card-body">
        <h4 class="card-title">GRANTING OF INCREMENT (if applicable)
        </h4>
        ...
        <form class="row g-3">
            ...
            <div class="form-check">
                <label class="form-check-label" for="inputPart5_2_2">
                    ...
                    stopped for
                    <span id="inutPart5_2_3"> </span> months.
            ...
            <p>
                ...
                <span id="inutPart5_3_1"> </span> months
                since <span id="inutPart5_3_2"> </span> (to
