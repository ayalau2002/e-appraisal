<div class="card">
    <div class="card-body">
        <h4 class="card-title">REVIEWING OFFICER’S ASSESSMENT</h4>

        <form class="row g-3">
            <div class="col-md-12">
                <label class="form-check-label" for="inputPart9_1">(1) Month/year of last career development
                    interview:</label>
                <input type="text" class="form-control" id="inputPart9_1" />
            </div>

            <div class="col-md-12">
                <label class="form-check-label" for="inputPart9_2">(2) Please make an overall assessment of the
            ...
            <div class="col-md-12">
                <label class="form-check-label" for="inputPart9_3">(3) Irrespective of seniority, is the officer
                    now ready to perform duties at the next higher
                    rank?</label>
                <select class="form-select" id="inputPart9_3">
            ...
            <div class="col-md-12">
                <label for="inputPart9_4" class="form-check-label">(4) What is your assessment of the officer’s
            ...
            <div class="col-md-12">
                <label class="form-check-label" for="inputPart9_5">(5) Other comments (including career
