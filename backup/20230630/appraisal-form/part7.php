<div class="tab-pane fade" id="v-pills-part7" role="tabpanel" aria-labelledby="v-pills-part7-tab">
    <div class="card">
        <div class="card-body">
            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">COUNTERSIGNING OFFICER’S ASSESSMENT</h4>
            ...
            <div class="card">
                <div class="card-body  pt-3">
                    <div class="row g-3">
                        <label class="form-label">Signed by Appraisee (Chan Tai Man)</label>

                        <div class="col-sm-3">
                            <div class="form-floating">
                                <input type="text" class="form-control" id="inputPart7_sign_1_1" value="Chan Tai Man">
                        ...
                        <div class="col-sm-3">
                            <div class="form-floating">
                                <input type="password" class="form-control" id="inputPart7_sign_1_2" value="Password">
