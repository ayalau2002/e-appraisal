<div class="tab-pane fade" id="v-pills-part4" role="tabpanel" aria-labelledby="v-pills-part4-tab">
    <div class="card">
        <div class="card-body">
            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">(1) ASSESSMENT OF COMPETENCIES
                    </h4>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-sm-3">
                            <div class="form-floating">
                                <input type="text" class="form-control" id="inputPart2_sign_1_1" value="Chan Tai Man">
                        ...
                        <div class="col-sm-3">
                            <div class="form-floating">
                                <input type="password" class="form-control" id="inputPart2_sign_1_2" value="Password">
