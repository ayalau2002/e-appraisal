          ...
          <div class="card" col-sm-12>
            <div class="card-body">
              ...
              <div class="d-flex align-items-start">
				<div class="nav flex-column nav-pills me-3 col-sm-1" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                ...
                <div class="tab-content me-3 col-sm-11" id="v-pills-tabContent">
                  <!-- PART 1 -->
                  <div class="tab-pane fade show active" id="v-pills-part1" role="tabpanel" aria-labelledby="v-pills-part1-tab">
                    <div class="card">
                      <div class="card-body">
                        ...
                        <h4 class="row mb-5">PERSONAL PARTICULARS</h4>
                        <form class="row g-3">
							...
							<div class="card">
								<div class="card-body">	
									...
									<div class="row mb-3">
										...
										<div class="col-sm-3">
											<input type="month" class="form-control" id="inputPart1_3" value="1970-07" />
										</div>
										<div class="col-sm-6"></div>									
									</div>
									...
									<div class="row mb-3">
										...
										<div class="col-sm-3">
											<input type="date" class="form-control" id="inputPart1_4_1" value="1995-12-31" />
										</div>
										<div class="col-sm-3">
									...
									<div class="row mb-3">
										...
										<div class="col-md-12">
											...
											<textarea type="text" class="form-control" id="inputPart1_5">Prepare a topographical survey of the property, including contours, spot elevations, and other relevant features. Produce a report detailing the survey results and providing any necessary recommendations or conclusions.</textarea>
										</div>									
									</div>

									<div class="row mb-3">
									  <label for="inputPart1_6" class="col-sm-3 form-label">(6) Present substantive rank and date of appointment to it:</label>
									  <div class="col-sm-3">
										<input type="date" class="form-control" id="inputPart1_6_1" value="2000-01-01" />
									  </div>
									  <div class="col-sm-3">
									...
									<div class="row mb-3">
										...
										<div class="col-sm-3">
											<input type="date" class="form-control" id="inputPart1_9" />
										</div>	
										<div class="col-sm-6"></div>
									</div>	
									...
									<div class="row mb-3">
										<div class="col-md-12">
											<label for="inputPart1_10" class=" form-label">(10) Commendations/Disciplinary offences during appraisal period:</label>
											<textarea type="text" class="form-control" col="4" id="inputPart1_10">1. Exhibited a strong work ethic and commitment to quality. 
...
3. Consistently demonstrated a high level of professionalism and dedication to the job.
									...
									<div class="row mb-3">
										<div class="col-md-12">
											<label for="inputPart1_11" class="form-label">(11) Any acting appointments during the appraisal period, regardless of duration, with dates:</label>
											<textarea type="text" class="form-control" id="inputPart1_11">Senior Land Surveyor (01.02.2023 - 30.04.2023)
											</textarea>
										</div>									
									</div>	
									...
									<div class="row mb-3">
										<div class="col-md-12">
											<label for="inputPart1_11" class="form-label">(12) Period and nature of leave lasting more than 1 month with dates:</label>
											<textarea type="text" class="form-control" id="inputPart1_11">XXX (01.05.2022 - 15.06.2022)
											</textarea>
										</div>																			
									</div>	
									...
									<div class="row mb-3">
										<div class="col-md-12">
											<label for="inputPart1_13" class="form-label">(13) Qualifications (academic, professional, technical, proficiency in language) acquired during the appraisal period:</label>
...
3. ZZZ
									...
									<div class="row mb-3">
										<div class="col-md-12">
											<label for="inputPart1_14" class="form-label">(14) Training courses attended during the appraisal period:</label>
...
3. ZZZ
									...
									<div class="row mb-3">
										<div class="col-md-12">
											<label for="inputPart1_15" class="form-label">(15) Views on future posting and / or training:</label>
...
2. Continued professional development and training to stay current on industry advancements and best practices.
							...
							<div class="card">
								<div class="card-body">	
									...
									<div class="row mb-3">
										<label for="inputPart1_sign_2_1" class="form-label">Signed by Appraisee (Chan Tai Man)</label>
									</div>
									...
									<div class="row mb-3">
										...
										<div class="col-sm-1">
											<div class="form-floating">
												...
												<label for="floatingInput">Chan Tai Man</label>
											</div>
										</div>

										<div class="col-sm-1">
											<div class="form-floating">
												<input type="password" class="form-control" id="inputPart1_sign_1_2" value="Password">
									...
									<div class="row mb-3">
										...
										<div class="col-sm-12">
											...
											<button class="btn btn-danger">Sign & Continue</button>
										</div>									
                      ...
                      <div class="card-body">
                        ...
                        <form class="row g-3">
                            ...
                            <table class="table table-bordered">
                              ...
                              <tbody>
                                <tr>
                                  <th scope="row">1</th>
                                  <td>
                                    <textarea class="form-control" id="inputPart2_1_1_1">Conduct field surveys to determine property boundaries and establish maps and other land survey documents</textarea>
                                  </td>
                                  <td>
                                    <input type="text" class="form-control" id="inputPart2_1_1_2" value="50%">
                                  </td>
                                </tr>
                                <tr>
                                  <th scope="row">2</th>
                                  <td>
                                    <textarea class="form-control" id="inputPart2_1_2_1">Research and analyze land records, maps, and survey data to verify property lines, easements, and other relevant information</textarea>
                                  </td>
                                  <td>
                                    <input type="text" class="form-control" id="inputPart2_1_2_2" value="20%">
                                  </td>
                                </tr>
                                <tr>
                                  <th scope="row">3</th>
                                  <td>
                                    <textarea class="form-control" id="inputPart2_1_3_1">Ensure compliance with relevant laws and regulations governing land surveying activities</textarea>
                                  </td>
                                  <td>
                                    <input type="text" class="form-control" id="inputPart2_1_3_2" value="15%">
                                  </td>
                                </tr>
                                <tr>
                                  <th scope="row">4</th>
                                  <td>
                                    <textarea class="form-control" id="inputPart2_1_4_1">Collaborate effectively with other professionals involved in land development projects to ensure successful outcomes</textarea>
                                  </td>
                                  <td>
                                    <input type="text" class="form-control" id="inputPart2_1_4_2" value="10%">
                                  </td>
                                </tr>
                                <tr>
                                  <th scope="row">5</th>
                                  <td>
                                    <textarea class="form-control" id="inputPart2_1_5_1">Maintain up-to-date knowledge of surveying techniques and technologies to improve efficiency and accuracy</textarea>
                                  </td>
                                  <td>
                                    <input type="text" class="form-control" id="inputPart2_1_5_2" value="5%">
                                  </td>
                                </tr>
                                <tr>
                                  <th scope="row">6</th>
                          ...
                          <div class="col-md-12">
                            ...
                            <textarea class="form-control" id="inputPart2_2">XXXXXXXXXXXXXXXXXXXXXXXXXX</textarea>
                          </div>
                          <div class="col-md-12">
                            <label for="inputPart2_3_1" class="form-label">(3) Please indicate any special tasks or
                              ...
                              mention.</label>
                            <textarea class="form-control" id="inputPart2_3_1">XXXXXXXXXXXXXXXXXXXXXXXXXX</textarea>
                          </div>
