<div class="card">
    <div class="card-body">
        <h4 class="card-title">FITNESS FOR PROMOTION</h4>
        ...
        <form class="row g-3">
            ...
            <div class="form-check">
                <label class="form-check-label" for="inputPart6_5">
                    (5) Not applicable as there is no promotion rank
                    for the rank Other reason(s):
                    <input id="inputPart6_5_1" />
                </label>
                <input class="form-check-input" type="checkbox" id="inputPart6_5" />
            </div>
        </form>
    </div>
</div>