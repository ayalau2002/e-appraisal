<div class="card">
    <div class="card-body">
        <form class="row g-3 mt-3">
            <h5>(1) ASSESSMENT OF COMPETENCIES</h5>
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <p id="inputPart4_H_1_1"></p>
                        </td>
                        <th scope="row">English</th>
                        <td>
                            <p id="inputPart4_H_1_2"></p>
                        </td>
                    </tr>
                    <tr>
                        <th scope="row">Chinese</th>
                        <td>
                            <p id="inputPart4_H_1_3"></p>
                        </td>
                        <th scope="row">Chinese</th>
                        <td>
                            <p id="inputPart4_H_1_4"></p>
                        </td>
                    </tr>
                    <tr>
                        <th scope="row"></th>
