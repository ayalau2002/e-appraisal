<div class="card">
    <div class="card-body">
        ...
        <form class="row g-3">
            ...
            <div class="col-sm-3">
                <p id="inputPart1_1" style="color:rgb(125, 0, 250);">Lands Department</p>
            </div>
