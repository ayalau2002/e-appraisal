<div class="card">
    <div class="card-body">
        ...
        <form class="row g-3">
            ...
            <div class="col-sm-3">
                <p id="inputPart1_1">Lands Department</p>
            </div>
...
Senior Land Surveyor (01.02.2023 - 30.04.2023)
            ...
            <div class="col-sm-3">
                <p id="inputPart1_12_1">XXX</p>
            </div>
            <div class="col-sm-3">
                <p id="inputPart1_12_2">(01.05.2022 - 15.06.2022)</p>
            </div>
            <div class="col-md-12">
