<div class="card">
    <div class="card-body">
        ...
        <form class="row g-3">
            ...
            <div class="col-sm-3">
                <p id="inputPart1_1" class="text-success">Lands Department</p>
            </div>
...
3. Consistently demonstrated a high level of professionalism and dedication to the job.
            ...
            <div class="col-md-12">
                <label for="inputPart1_11" class="form-label">(11) Any acting appointments during the
                    ...
                    dates:</label>
                <pre id="inputPart1_11" class="text-success">
Senior Land Surveyor (01.02.2023 - 30.04.2023)
            ...
            <div class="col-sm-3">
                <p id="inputPart1_12_1" class="text-success">XXX</p>
            </div>
            <div class="col-sm-3">
                <p id="inputPart1_12_2" class="text-success">(01.05.2022 - 15.06.2022)</p>
            </div>
            <div class="col-md-12">
                ...
                <pre id="inputPart1_13" class="text-success">
1. XXXX
2. YYYY
3. ZZZ
                              </pre>
            ...
            <div class="col-md-12">
                <label for="inputPart1_14" class="form-label">(14) Training courses attended during the
                    appraisal period:</label>
                <pre id="inputPart1_14" class="text-success">
1. XXXX
2. YYYY
3. ZZZ
                            </pre>
            ...
            <div class="col-md-12">
                <label for="inputPart1_15" class="form-label">(15) Views on future posting and / or
                    training:</label>
                <pre id="inputPart1_15" class="text-success">
