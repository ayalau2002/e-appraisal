<div class="card">
    <div class="card-body">
        ...
        <form class="row g-3">
            ...
            <div class="col-sm-3">
                <p id="inputPart1_6_1" class="text-success">01.01.2019</p>
            </div>
            <div class="col-sm-3">
            ...
            <div class="col-sm-3">
                <p id="inputPart1_8" class="text-success">20</p>
            </div>
            ...
            <div class="col-md-12">
                ...
                <pre col="4" id="inputPart1_10"></pre>
            </div>
            ...
            <div class="col-md-12">
                <label for="inputPart1_11" class="form-label">(11) Any acting appointments during the
                    ...
                    dates:</label>
                <pre id="inputPart1_11" class="text-success"></pre>
            </div>
            ...
            <div class="col-sm-3">
                <p id="inputPart1_12_2" class="text-success"></p>
            </div>
            <div class="col-md-12">
