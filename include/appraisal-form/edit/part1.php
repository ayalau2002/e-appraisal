<div class="card">
    <div class="card-body">
        ...
        <form class="row g-3">
            ...
            <div class="col-sm-3">
                <input type="text" class="form-control" id="inputPart1_2_1" value="Chan Tai Man" />
            </div>
            <label for="inputPart1_2_2" class="col-sm-3 form-label">Chinese Name:</label>
            <div class="col-sm-3">
                <input type="text" class="form-control" id="inputPart1_2_2" value="陳大文" />
            </div>

            <label for="inputPart1_3" class="col-sm-3 form-label">(3) Month and year of birth:</label>
            <div class="col-sm-3">
                <input type="text" class="form-control datepickerMonth" id="inputPart1_3" value="07.1970" />
            </div>
            <div class="col-sm-6"></div>

            <label for="inputPart1_4" class="col-sm-3 form-label">(4) Date and rank of first appointment:</label>
            <div class="col-sm-3">
                <input type="text" class="form-control datepicker" id="inputPart1_4_1" value="01.01.1995" />
            </div>
            <div class="col-sm-3">
            ...
            <div class="col-md-12">
                ...
                <textarea type="text" class="form-control" id="inputPart1_5">New Permanent Terms</textarea>
            </div>

            <label for="inputPart1_6" class="col-sm-3 form-label">(6) Present substantive rank and date of appointment to it:</label>
            <div class="col-sm-3">
                <input type="text" class="form-control datepicker" id="inputPart1_6_1" value="01.01.2000" />
            </div>
            <div class="col-sm-3">
            ...
            <div class="col-sm-3">
                <input type="text" class="form-control datepicker" id="inputPart1_7_2" value="01.01.2020" />
            </div>
            <div class="col-sm-3"></div>
            ...
            <div class="col-md-12">
                ...
                <textarea type="text" class="form-control" col="4" id="inputPart1_10"></textarea>
            </div>
...
Senior Land Surveyor (01.02.2023 - 30.04.2023)
            ...
            <div class="col-sm-3">
                <input type="text" class="form-control daterange" id="inputPart1_12_2" value="01.05.2022 - 15.06.2022" />
            </div>
            <div class="col-md-12">
